...
- **04b's backdrop is stale**: the 04b frame still draws the pre-Selector 02 behind its scrim (159-tall cards at y470, old 16px ⊕) while 02 itself moved to 162-tall cards at y473. Until that frame re-syncs, `npm run diff -- 04b-add-card-sheet` reads ~1.3% and is expected to exceed the gate.
