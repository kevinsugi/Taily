...
- **The Jul 12 fiction (Phase R1)** — appointment `Sunday Jul 12, 7PM`; need-by `Jul 17, 3:00PM`; deposit 7/7; delivery 7/17. All frames synced. Remaining frame quirks, carried verbatim: 04C/05's tailor card rows read `▤ Fri, Jul 17 · 7:00PM` (not the Jul 12 appointment) and `Need By: Thurs, Jul 17` (Jul 17, 2026 is a Friday); 09's James card badge says `JUL 3` while its meta says `Completed: Jul 1, 3PM`; 07A/07B select the `Fri 4–6 PM` chip while their CTAs still read `Confirm … · Thu 9–11 AM`; 01's card lists two item lines under "3 Items Total" where 09's lists three (01 slices verbatim).
