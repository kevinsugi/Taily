/* UX-LOOP round 3 Figma sync — fixture route for the sibling frame
   "03 - Order Status / Declined". Renders the base screen with the round-2 live-only state
...
import { APPT_DECLINED } from '../fixtures.js';

register('03-status-declined', (s) => viewCancelled(s, APPT_DECLINED()), wire);
