/* ============================================================
   ...
   Round 12 (Kevin): the popup is informational — Sounds Good just
   closes it (the round-2 requestChanges trace, canned chat bubble and
   the tailor's "Sarah has questions" state are gone). Copy: "Please
   work together with Marco to review your order. Tailoring prices are
   standardized and non-adjustable."
   ============================================================ */
...
function modalHtml() {
  ...
  <p class="modal__body">Please work together with Marco to review your order.<br><br>Tailoring prices are standardized and non-adjustable.</p>
