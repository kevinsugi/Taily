...
import { view04d } from './04d-appointment-complete.js';
...
function renderScreen(s) {
  return `<div class="screen-sheet" data-s="pv3-photo-viewer">
  <div class="sheet-backdrop" aria-hidden="true">${view04d(s)}</div>
...
function wire(root) {
  wirePanel(root, () => go('04d-appointment-complete'));
}

register('pv3-photo-viewer', renderScreen, wire);
