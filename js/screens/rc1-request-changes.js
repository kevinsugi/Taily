...
export function openRequestChanges() {
  modalOverlay(modalHtml(), { dataS: 'rc1-request-changes' }, wireModal);
}

/* Route registration keeps the frame-verbatim render for the diff
   harness: the frame draws 05 as its backdrop. */
function renderScreen(s) {
  return `<div class="screen-sheet" data-s="rc1-request-changes">
...
function wire(root) {
  wireModal(root, () => go('06b-review-approve-modified'));
}

register('rc1-request-changes', renderScreen, wire);
